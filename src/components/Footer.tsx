        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://m.facebook.com/100066676570121/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-slate-800 hover:bg-emerald-600 p-2 rounded-lg transition-colors duration-300"
              >
                <Facebook className="w-5 h-5" />
              </a>
              <a 
                href="https://www.instagram.com/ismernakulam?igsh=MXB4NnNkZjRvazduaA==" 
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-slate-800 hover:bg-emerald-600 p-2 rounded-lg transition-colors duration-300"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-slate-800 hover:bg-green-600 p-2 rounded-lg transition-colors duration-300"
              >
              ...
              <a 
                href="https://www.youtube.com/@ISMINSPIRE" 
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-slate-800 hover:bg-red-600 p-2 rounded-lg transition-colors duration-300"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
