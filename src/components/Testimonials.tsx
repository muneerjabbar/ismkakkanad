  ...
  const testimonials: Testimonial[] = [
    {
      ...
      avatar: import.meta.env.BASE_URL + 'images/noorsha.png'
    },
    {
      ...
      avatar: import.meta.env.BASE_URL + 'images/shereef_melethil.png'
    },
    {
      ...
      avatar: import.meta.env.BASE_URL + 'images/shukkoor_swal.png'
    },
    {
      ...
      avatar: import.meta.env.BASE_URL + 'images/subair_pediekkal.png'
    },
    {
      quote: `യുക്തി ദീക്ഷയോടുകൂടിയും, സദുപദേശം മുഖേനയും നിന്റെ രക്ഷിതാവിന്റെ മാർഗ്ഗത്തിലേക്ക് നീ ക്ഷണിച്ചുകൊള്ളുക എന്ന ഖുർആന്റെ വചനങ്ങളെ ഹൃദയത്തോട് ചേർത്ത് പ്രവർത്തിക്കുവാൻ റബ്ബ് എന്റെ കാക്കനാട് മണ്ഡലം പ്രവർത്തകരെ റബ്ബ് സഹായിക്കട്ടെ, ആമീൻ. നന്മകളിൽ മുൻപിൽ നിൽക്കുവാൻ എന്നും ശ്രമിക്കുന്നവർ ആണ് കാക്കനാട് മണ്ഡലം ഐ എസ് എം. റബ്ബ് അത് നിലനിർത്തട്ടെ.`,
      name: "ഫാരിഷ്",
      role: "ജില്ലാ സെക്രട്ടറി, ഐ.എസ്.എം. എറണാകുളം",
      avatar: import.meta.env.BASE_URL + 'images/pharish.png'
    },
    {
      ...
      avatar: import.meta.env.BASE_URL + 'images/sageer.png'
    },
    {
      ...
      avatar: import.meta.env.BASE_URL + 'images/dr_abdul_rasheed.png'
    },
    {
      quote: `എന്തും വിരൽ തുമ്പിൽ ലഭ്യമാകുന്ന പുതിയ കാലത്ത് ഖുർആൻ്റെയും സുന്നത്തിൻ്റെയും വെളിച്ചത്തിൽ  തൗഹീദിൻ്റെയും  സുന്നത്തിൻ്റെയും ദഅവ സ്പന്ദനങ്ങൾ  ജനമനസ്സുകളിലേക്ക് എത്തിക്കാൻ ഐ.എസ്.എം കാക്കനാട് മണ്ഡലം കാണിക്കുന്ന താത്പര്യവും പരിശ്രമവും അഭിനന്ദനാർഹവും മാതൃകാപരവുമാണ്.റബ്ബ് സ്വീകരിക്കുമാറാകട്ടെ`,
      name: "ആസിഫ് ഇസ്ലാഹി",
      role: "പ്രസിഡൻ്റ് എം.എസ്.എം എറണാകുളം",
      avatar: import.meta.env.BASE_URL + 'images/asif_islahi.jpg'
    }
  ];
