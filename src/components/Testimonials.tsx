...
const Testimonials = () => {
  ...
  const testimonials: Testimonial[] = [
    ...
    {
      quote: `എന്തും വിരൽ തുമ്പിൽ ലഭ്യമാകുന്ന പുതിയ കാലത്ത് ഖുർആൻ്റെയും സുന്നത്തിൻ്റെയും വെളിച്ചത്തിൽ യഥാർത്ഥ തൗഹീദിൻ്റ ദഅവ സ്പന്ദനങ്ങൾ  ജനമനസ്സുകളിലേക്ക് എത്തിക്കാൻ ഐ.എസ്.എം കാക്കനാട് മണ്ഡലം കാണിക്കുന്ന താത്പര്യവും പരിശ്രമവും അഭിനന്ദനാർഹവും മാതൃകാപരവുമാണ്.റബ്ബ് സ്വീകരിക്കുമാറാകട്ടെ`,
      name: "ആസിഫ് ഇസ്ലാഹി",
